        ...
        match block {
            ...
            Rendered::Code {
                ...
                for fig in figures {
                    ...
                    if let Err(e) = rustlab_plot::render_figure_state_to_file(
                        fig,
...
mod tests {
    ...
    fn generated_banner_is_emitted() {
        let md = render_markdown("Hello", &[], &tmp_plot_dir(), "img");
    ...
    fn markdown_passthrough() {
        ...
        let md = render_markdown("T", &blocks, &tmp_plot_dir(), "img");
    ...
    fn plot_reference_uses_relative_path() {
        ...
        let md = render_markdown("T", &blocks, &plot_dir, "plots/quick_look");
