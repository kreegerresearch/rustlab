...
[p,f]=check('sum(M) default',        'ref2_sum_matrix_default.csv','out2_sum_matrix_default.csv',T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('sum(M, 2)',             'ref2_sum_matrix_dim2.csv',   'out2_sum_matrix_dim2.csv',   T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('mean(M) default',       'ref2_mean_matrix_default.csv','out2_mean_matrix_default.csv',T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('mean(M, 2)',            'ref2_mean_matrix_dim2.csv',  'out2_mean_matrix_dim2.csv',  T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('prod(M) default',       'ref2_prod_matrix_default.csv','out2_prod_matrix_default.csv',T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('max(M) default',        'ref2_max_matrix_default.csv','out2_max_matrix_default.csv',T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('min(M) default',        'ref2_min_matrix_default.csv','out2_min_matrix_default.csv',T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('median(M) default',     'ref2_median_matrix_default.csv','out2_median_matrix_default.csv',T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('std(M) default',        'ref2_std_matrix_default.csv', 'out2_std_matrix_default.csv', T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('cumsum(M) default',     'ref2_cumsum_matrix_default.csv','out2_cumsum_matrix_default.csv',T_EXACT); pass_count+=p; fail_count+=f;
[p,f]=check('cumsum(M, 2)',          'ref2_cumsum_matrix_dim2.csv','out2_cumsum_matrix_dim2.csv',T_EXACT); pass_count+=p; fail_count+=f;
