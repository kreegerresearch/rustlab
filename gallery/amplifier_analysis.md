...
<!-- rustlab:output-start -->
![plot 1](plots/amplifier_analysis/plot-1-d021e799.svg)
...
<!-- rustlab:output-start -->
![plot 2](plots/amplifier_analysis/plot-2-53c0ca9c.svg)
...
<!-- rustlab:output-start -->
![plot 3](plots/amplifier_analysis/plot-3-ccdf945f.svg)
...
<!-- rustlab:output-start -->
![plot 4](plots/amplifier_analysis/plot-4-4dc99b8f.svg)
...
<!-- rustlab:output-start -->
![plot 5](plots/amplifier_analysis/plot-5-02df3555.svg)
...
```text
f/GHz     VSWR1    VSWR2   RL1/dB    IL/dB
1.00       3.00     2.33     6.02    -7.96
2.00       2.64     2.23     6.94    -9.54
3.00       2.33     2.12     7.96   -10.10
4.00       2.23     2.03     8.40    -9.83
5.00       2.12     1.94     8.87    -8.94
6.00       2.03     1.86     9.37    -7.60
```
...
```text
f/GHz                Γms               Γml   MAG/dB
1.00     0.524∠-156.7°     0.430∠178.5°      10.06
2.00     0.499∠-149.6°     0.437∠-179.1°      11.38
3.00     0.473∠-141.9°     0.439∠-174.9°      11.70
4.00     0.468∠-132.3°     0.436∠-170.3°      11.32
5.00     0.450∠-121.6°     0.418∠-164.5°      10.29
6.00     0.421∠-110.2°     0.388∠-158.0°       8.78
```
...
<!-- rustlab:output-start -->
```text
Γin(Γml) - conj(Γms) at 3 GHz: 1.24e-16
Γout(Γms) - conj(Γml) at 3 GHz: 1.19e-16
```
...
<!-- rustlab:output-start -->
```text
Original: 6 points,  Interpolated: 26 points
...
<!-- rustlab:output-start -->
```text
Single-ended tag: S   Mixed-mode tag: Smm
Sdd21 (diff → diff): 0.750∠0.0°
Scd21 (common → diff, ideally zero): 0.000
```
...
<!-- rustlab:output-start -->
```text
smm2s round-trip diff at port (2,1): 3.33e-16
```
