...
<!-- rustlab:output-start -->
```text
[1×2]  513.000000  153.000000
```

![plot 2](plots/time_frequency/plot-2-643eb0e3.svg)
...
<!-- rustlab:output-start -->
![plot 3](plots/time_frequency/plot-3-52069ca6.svg)
...
<!-- rustlab:output-start -->
![plot 4](plots/time_frequency/plot-4-58ff4897.svg)
...
<!-- rustlab:output-start -->
![plot 5](plots/time_frequency/plot-5-d604f332.svg)
...
<!-- rustlab:output-start -->
```text
[1×2]  64.000000  20000.000000
```

![plot 6](plots/time_frequency/plot-6-d1029518.svg)
...
<!-- rustlab:output-start -->
![plot 7](plots/time_frequency/plot-7-26f16f4e.svg)
