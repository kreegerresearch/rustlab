...
cache: active (.rustlab/cache.db)
  scope: all user-defined functions
  this session: 1 hits, 2 misses
    skipped: 0 impure, 0 free-var, 0 non-cacheable arg, 0 stale-blob
  per function:
    heavy                          1 hits,      2 misses
```
...
<!-- rustlab:output-start -->
```text
cache: loaded 3 function(s) from cache_demo_helpers.rlab
sum_of_squares(2000) = 2668667000
cache: active (.rustlab/cache.db)
  scope: all user-defined functions
  loaded fns: heavy, square, sum_of_squares
  this session: 1 hits, 2003 misses
    skipped: 0 impure, 0 free-var, 0 non-cacheable arg, 0 stale-blob
  per function:
    heavy                          1 hits,      2 misses
    square                         0 hits,   2000 misses
    sum_of_squares                 0 hits,      1 misses
```
